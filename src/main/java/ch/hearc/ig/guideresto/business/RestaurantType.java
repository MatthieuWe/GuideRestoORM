 ...
 */
@NamedQuery(name="RestaurantType.count", query="select count (rt) from RestaurantType rt")
@NamedQuery(name="RestaurantType.findByLabel", query="SELECT ty FROM RestaurantType ty WHERE LOWER(ty.label) = LOWER(:label)")
@Entity
